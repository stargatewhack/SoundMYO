 ...
 *  	a) Play/Pause 		-> Gesture: Clench Fist 				~ Haptic Feedback x1
 *  	b) Back/Fwd Song 	-> Gesture: (    ) + Swipe Left/Right 	~ Haptic Feedback x1
 *  	c) Shuffle On/Off 	-> Gesture: (    )						~ Haptic Feedback ON x1/ OFF x2
 *  	d) Repeat On/Off 	-> Gesture: (    )						~ Haptic Feedback ON x1/ OFF x2
 */
